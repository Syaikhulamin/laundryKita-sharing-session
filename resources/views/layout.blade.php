        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link @yield('menu-dashboard-active')" href="{{ route('dashboard') }}">Dashboard</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link @yield('menu-transaksi-active')" href="#">Transaksi</a></li>
                </ul>
            </div>
        </div>
    </nav>
